...
// итоговые затраты пам€ти: max(M+N, 80) + 16 + 4 + 4 + max(2*K, 80) + 24 = max(M+N, 80) + max(2*K, 80) + 44 байт
...
// “ест со строками разной длины (a > b)
void TEST_3() {
...
// “ест с изоморфными строками, содержащими все допустимые символы

void TEST_6() {
	std::string line_1{ "qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбюqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбю" };
	std::string line_2{ "юqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбюqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьб" };
	std::unordered_map<char, char> saved_letters;
	assert(are_isomorph(&line_1, &line_2, &saved_letters) == 1);

}

// “ест с неизоморфными строками, содержащими все допустимые символы
void TEST_7() {
	std::string line_1{ "qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбюqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбю" };
	std::string line_2{ "юqwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьбюqwertyuiopasdfghjkldfcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890йцукенгшщзхъфывапролджэ€чсмитьб" };
	std::unordered_map<char, char> saved_letters;
	assert(are_isomorph(&line_1, &line_2, &saved_letters) == 0);
